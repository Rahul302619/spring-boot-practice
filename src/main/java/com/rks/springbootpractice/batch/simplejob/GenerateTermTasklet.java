...
@Component
@Slf4j
public class GenerateTermTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("Generate terms based on facility, collateral and covenant data for eventId : {} and jobId : {}", eventId, jobId);
